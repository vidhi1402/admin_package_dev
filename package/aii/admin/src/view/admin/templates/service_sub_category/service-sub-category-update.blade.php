...
<div class="panel-body">
    <div class="row">
        <form method="post" role="form" action="{{ Route('admin.service_sub_category.update') }}">
            {{csrf_field()}}
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <button type="submit" value="{{ $id->id_service_sub_category }}" name="selected_id" class="btn btn-primary">
                        Update
                    </button>
                </div>
            </div>
